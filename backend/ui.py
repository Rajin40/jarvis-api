...
class ChatSection(QWidget):
    ...
    def sendMessage(self):
        ...
        if query:
            ...
            self.addMessage(f"{AssistantName}: {modified_query}", color='blue')
            SaveQueryToFile(modified_query)
...
class MessageScreen(QWidget):
    def __init__(self, parent=None):
        ...
        layout = QVBoxLayout()
        labelsthe = QLabel("")
        layout.addWidget(labelsthe)  # Corrected from 'label' to 'labelsthe'
